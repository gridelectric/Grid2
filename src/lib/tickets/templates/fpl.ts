...
export const fplPayloadSchema = z
  .object({
...
export const FPL_TEMPLATE: TicketTemplateDefinition = {
  templateKey: 'FPL_TROUBLE_TICKET_V1',
  utilityClient: 'FPL',
  displayName: 'FPL Trouble Ticket',
  schema: fplPayloadSchema,
  payloadVersion: 1,
  defaultValues: {
    external_ticket_id: '',
    ticket_type: '',
