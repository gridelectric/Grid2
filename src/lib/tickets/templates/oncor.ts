...
export const oncorPayloadSchema = z
  .object({
...
export const ONCOR_TEMPLATE: TicketTemplateDefinition = {
  templateKey: 'ONCOR_TROUBLE_TICKET_V1',
  utilityClient: 'ONCOR',
  displayName: 'Oncor Trouble Ticket',
  schema: oncorPayloadSchema,
  payloadVersion: 1,
  defaultValues: {
    external_ticket_id: '',
    ticket_type: '',
