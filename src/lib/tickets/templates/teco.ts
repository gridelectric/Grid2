...
export const tecoPayloadSchema = z
  .object({
...
export const TECO_TEMPLATE: TicketTemplateDefinition = {
  templateKey: 'TECO_TROUBLE_TICKET_V1',
  utilityClient: 'TECO',
  displayName: 'TECO Trouble Ticket',
  schema: tecoPayloadSchema,
  payloadVersion: 1,
  defaultValues: {
    external_ticket_id: '',
    ticket_type: '',
