...
export const centerpointPayloadSchema = z
  .object({
...
export const CENTERPOINT_TEMPLATE: TicketTemplateDefinition = {
  templateKey: 'CENTERPOINT_TROUBLE_TICKET_V1',
  utilityClient: 'CENTERPOINT',
  displayName: 'CenterPoint Trouble Ticket',
  schema: centerpointPayloadSchema,
  payloadVersion: 1,
  defaultValues: {
    external_ticket_id: '',
    ticket_type: '',
